...
public class SessionStore {
    ...
    public Optional<Session> findByIdWithEnrichedSpeakers(String sessionId) {
        ...
        List<SpeakerFromService> allSpeakers;
    ...
    private Optional<Speaker> getSpeakerByNameFromService(final String speakerName) {
        ...
        if (localSpeaker.isPresent()) {
            ...
            serviceSpeaker.ifPresent(speakerFromService -> Speaker.enrichFromService(speakerFromService, speaker));
            return localSpeaker;
        } else {
            return serviceSpeaker.map(Speaker::from);
        }
